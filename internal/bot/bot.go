...
type Bot struct {
	...
	music *music.Registrar // optional Spotify paste hook; nil when music is disabled
}
...
// the bot package having to know how they are constructed.
func (b *Bot) Raw() *tele.Bot { return b.tb }

// SetMusic attaches the optional music registrar whose paste hook runs before
// the legacy media pipeline. Must be called before Start; nil is fine (the
// registrar methods are nil-safe and simply do nothing).
func (b *Bot) SetMusic(r *music.Registrar) { b.music = r }
